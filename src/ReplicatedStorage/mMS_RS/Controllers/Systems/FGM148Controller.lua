...
local locker: TargetLocker.TargetLocker
local rayParams: RaycastParams
local root: any
local clu: ScreenGui
local zoomed: boolean



local FGM148Controller = Knit.CreateController({
    Name = "FGM148Controller",
    OnStateUpdated = Signal.new(),
    OnZoomToggled = Signal.new(),
...
function FGM148Controller:Initialize(model: Model)
    -- set up the CLU
...
function FGM148Controller.Destroy(self: FGM148Controller)
