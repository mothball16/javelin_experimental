...
local function WFOVStadia(props: {
...
return e("Frame", {
    ...
    Visible = (props.zoomType() == "wide")
	}, {
	StadiaLeft = e("Frame", {
	AnchorPoint = Vector2.new(1.000, 0.000),
	Position = UDim2.new(0.490, 0, 0.000, 0),
	...
	StadiaRight = e("Frame", {
	Position = UDim2.new(0.510, 0, 0.000, 0),
	Size = UDim2.new(0.000, 3, 0.250, 0),
	ZIndex = -100000,
	BorderSizePixel = 1,
	BackgroundColor3 = Color3.fromRGB(255, 255, 255),
	...
	Position = UDim2.new(0.500, 0, 0.375, -1),
	Size = UDim2.new(0.020, 0, 0.000, 3),
	ZIndex = -100000,
	BorderSizePixel = 1,
	BackgroundColor3 = Color3.fromRGB(255, 255, 255),
	}),
	...
	Position = UDim2.new(0.500, 0, 0.625, 1),
	Size = UDim2.new(0.020, 0, 0.000, 3),
	ZIndex = -100000,
	BorderSizePixel = 1,
	BackgroundColor3 = Color3.fromRGB(255, 255, 255),
	...
	Position = UDim2.new(0.313, -1, 0.500, 0),
	Size = UDim2.new(0.000, 3, 0.060, 0),
	ZIndex = -100000,
	BorderSizePixel = 1,
	BackgroundColor3 = Color3.fromRGB(255, 255, 255),
	}),
	...
	Position = UDim2.new(0.688, 1, 0.500, 0),
	Size = UDim2.new(0.000, 3, 0.060, 0),
	ZIndex = -100000,
	BorderSizePixel = 1,
	BackgroundColor3 = Color3.fromRGB(255, 255, 255),
